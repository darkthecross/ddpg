...
for i in range(MAX_EPISODES):
    ...
    for j in range(MAX_EP_STEPS):
        ...
        a = np.clip(np.random.normal(a, var), -0.02, 0.02)    # add randomness to action selection for exploration
        s_, r = env.step(a)
        done = False
